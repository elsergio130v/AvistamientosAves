...
<html lang="es">
    ...
    <body>
        ...
        <form action="ControllerCrear" method="post">
            ...
            <input type="text" name="anilla" placeholder="Anilla" value="${ave.anilla}">
            ...
            <button type="submit" name="enviar" class="button-30">Añadir</button>
